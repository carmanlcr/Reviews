...
public class RobotClickController {
	...
	/**
	 * Colocar mouse en una posiciÃ³n de la pantalla en especifica
	 * 
	 * @author Luis Morales
	 * @version 1.0.0
	 * @param x posiciÃ³n en equis(x) del mouse
	 * @param y posiciÃ³n en y del mouse
	 */
	...
	/**
	 * Hacer scroll de manera random, valores negativo indica movimiento hacÃ­a arriba,
	 * valores positivos indica valores hacÃ­a abajo
	 * 
	 * @author Luis Morales
	 * @version 1.0.0
	 * @param value
	...
	protected void inputWrite(String inputData) throws InterruptedException {
		RobotClickController rob = new RobotClickController();
