...
public class IniciaSesion {
	...
	public boolean init() throws InterruptedException {
		...
		if(dr.searchElement(1, "/html/body/div[1]/div[1]/div[2]/div[2]/div/div/div[2]/div/div[1]/div/form/span/section/div/div/div[1]/div/div[2]/div[2]/div") != 0) {
			return false;
		}else if(dr.searchElement(1, "//span[contains(text(),'No se ha podido encontrar tu cuenta de Google')]") != 0){
			return false;
		}else {
